    ...
    <div>
      ...
      <div className='bg-beige'>
        <div className='flex flex-col items-center'>
          <div>
            <p className='mt-3 text-5xl pt-10 pb-3 font-medium font-semibold text-black'>About Us</p>
          </div>
      ...
      <div className='m-5 flex flex-col'>
        ...
        <div className="card w-96 bg-base-100 card-xl shadow-sm bg-sand w-full items-center mt-2">
          <div className=''>
            <img src="https://t4.ftcdn.net/jpg/08/34/26/69/360_F_834266922_yG4cgGtcJ7UtAKPPvN4aie2Sc1qxRZzh.jpg" className='w-80 h-70 lg:w-150 lg:h-100 rounded-2xl mt-5'></img>
          </div>
